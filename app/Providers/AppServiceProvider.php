...
use App\Services\Payments\PaymentDeadlineExtensionService;
...
final class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(PaymentDeadlineExtensionServiceContract::class, PaymentDeadlineExtensionService::class);
